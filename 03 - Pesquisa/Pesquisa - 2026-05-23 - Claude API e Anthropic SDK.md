...
- Assinaturas Claude divididas em dois grupos: **uso próprio** vs **Agent SDK** (terceiros)
- Crédito mensal Agent SDK: Pro = $20 | Max 5x = $100 | Max 20x = $200
...
- 12 plug-ins de área de prática (advocacia — pesquisa, contratos, discovery)
...
## Lacunas
- Quais workloads específicos se beneficiam mais do Self-Hosted Sandboxes?
